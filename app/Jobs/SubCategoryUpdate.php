...
class SubCategoryUpdate implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $subCategoryData = ProductSubCategory::where('id',$getdata['subcatid'])->update($input); 

        $delmatno = DB::table('product_size_mat_no')->where('plant_type',$getdata['plant_code'])->where('sub_cat_id',$getdata['subcatid'])->delete();
