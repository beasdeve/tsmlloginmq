  ...
  */
      ...
      // $rfq_num = (!empty($rfq_number)) ? $rfq_number : rand(100,9999);
       if(!empty($request->input('quantity')))
       {
        ...
        $quoteArr['id'] = $quote['id'];
        RfqCreated::dispatch($quoteArr);
        ...
        foreach ($schedules as $key => $value) {
          ...
          $retid = QuoteSchedule::create($sche);

          $sche['id'] = $retid['id'];
          RfqScheduleCreated::dispatch($sche);
        }
  ...
  */
      public function updateQuoteSche(Request $request)
      {
        ...
        try{
          ...
          $arr['sche_no'] = $id;
          $arr['status'] = $status;
          RfqScheStatusUpdate::dispatch($arr);
    ...
    /*---------------------------- submit PO -----------------------------------------*/
      ...
      public function submitPo(Request $request)
      {
       ...
       try{
            ...
            $po = Order::create($poArr);

            $poArr['id'] = $po->id;
            PoCreated::dispatch($poArr);
     ...
     public function getPoSchedules($qid)
      ...
      public function updatePo(Request $request)
      {
       ...
       try{
            ...
            // echo "<pre>";print_r($poArr);exit();
            $arr['po_no'] = $po_no;
            $arr['amdnt_no'] = $request->input('amdnt_no');

            Order::where('po_no',$po_no)->update($poArr);
            PoUpdate::dispatch($arr);
      ...
      public function updateLetterhead(Request $request)
      {
       ...
       try{
            ...
            // echo "<pre>";print_r($poArr);exit();
                ...
                Order::where('po_no',$po_no)->update($poArr);
                $poArr['po_no'] = $po_no;
                PoLetterheadUpdate::dispatch($poArr);
